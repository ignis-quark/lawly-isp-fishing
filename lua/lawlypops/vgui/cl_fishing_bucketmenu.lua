...
function MENU:CreateMenu(ent, tbl, cmd)
    ...
    PNL.ItemTitle:SetTextColor(color_white)
    ...
    PNL.ItemPrice:SetVisible(false)
    PNL.ItemPrice:SetTextColor(color_white)
    ...
    PNL.ItemLength:SetVisible(false)
    PNL.ItemLength:SetTextColor(color_white)
    ...
    PNL.ItemLengthBar:SetFGColor(color_white)
    PNL.ItemLengthBar:SetVisible(false)
    ...
    if shop == nil or #MENU.Table == 0 then
        ...
        PNL.SellHint:SetTextColor(color_white)
    ...
    PNL.MostValText:SetText("Most expensive item: $" .. MENU.ItemTotal.MostExpensive)
    PNL.MostValText:SetTextColor(color_white)
    ...
    PNL.SellTrashBtn:SetTextColor(color_white)
    ...
    PNL.SellAllBtn:SetTextColor(color_red)
