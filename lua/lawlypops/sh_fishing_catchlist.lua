...
LAWLYFISH.FishList = {
    ...
    {Name="Wells Catfish",  Weight = 90,  Worth = 20, MaxLength = 120,Mdl = "basa" },
    ...
    {Name="Perch",          Weight = 90,  Worth = 20, MaxLength = 105,Mdl = "anabass" }, --Yes, I know it's supposed to be one "s"
    --Uncommon (80)
    {Name="Bluegill",       Weight = 85,  Worth = 80, MaxLength = 30, Mdl = "FUCK" },
    {Name="Cod",            Weight = 85,  Worth = 120, MaxLength = 200,Mdl = "FUCK" },
    {Name="Salmon",         Weight = 85,  Worth = 70, MaxLength = 76, Mdl = "FUCK" },
    {Name="Brook Trout",    Weight = 80,  Worth = 120, MaxLength = 90, Mdl = "FUCK" },
    {Name="Albacore Tuna",  Weight = 80,  Worth = 125, MaxLength = 140,Mdl = "FUCK" },
    {Name="Sea Turtle",     Weight = 80,  Worth = 120, MaxLength = 120,Mdl = "FUCK" },
    {Name="Slimy Eel",      Weight = 80,  Worth = 120, MaxLength = 127,Mdl = "FUCK" },
    --Rare (60)
    {Name="Herring",        Weight = 70,  Worth = 200, MaxLength = 45, Mdl = "FUCK" },
    {Name="Pike",           Weight = 70,  Worth = 400, MaxLength = 150,Mdl = "FUCK" },
    {Name="Lobster",        Weight = 60,  Worth = 350, MaxLength = 60, Mdl = "FUCK" },
    {Name="Rainbow Fish",   Weight = 60,  Worth = 200, MaxLength = 10, Mdl = "FUCK" },
    {Name="Silver Carp",    Weight = 60,  Worth = 350, MaxLength = 110,Mdl = "carp" },
    --Very Rare (40)
    {Name="Boxer Shrimp",   Weight = 45,  Worth = 500, MaxLength = 4,  Mdl = "FUCK" },
    {Name="Leaping Sturgeon",Weight= 50,  Worth = 500, MaxLength = 720,Mdl = "FUCK" },
    {Name="Largemouth Bass",Weight = 40,  Worth = 550, MaxLength = 75, Mdl = "FUCK" },
    {Name="Leaping Trout",  Weight = 40,  Worth = 500, MaxLength = 80, Mdl = "FUCK" },
    {Name="Leaping Salmon", Weight = 40,  Worth = 500, MaxLength = 150,Mdl = "FUCK" },
    --Epic (10)
    {Name="Cave Eel",       Weight = 25,  Worth = 600, MaxLength = 400,Mdl = "FUCK" },
    {Name="Greater Siren",  Weight = 15,  Worth = 800, MaxLength = 97, Mdl = "FUCK" },
    {Name="Monkfish",       Weight = 10,  Worth = 800, MaxLength = 150,Mdl = "FUCK" },
    {Name="Swordfish",      Weight = 10,  Worth = 1100,MaxLength = 455,Mdl = "FUCK" },
    ...
    {Name="King Mackerel",  Weight = 7,  Worth = 2000, MaxLength = 184,Mdl = "FUCK" },
    ...
    {Name="Golden Trout",   Weight = 0.1,Worth = 13000, MaxLength = 30, Mdl = "FUCK" },
    {Name="Holy Mackerel",  Weight = 0.1,Worth = 25200, MaxLength = 250,Mdl = "FUCK" },
