...
LAWLYFISH.FishList = {
    ...
    --Mythical (1)
    {Name="Atlantic Bluefin Tuna",Weight=8,Worth= 200,MaxLength = 460,Mdl = "bluefin_tuna" },
    ...
    {Name="Southern Bluefin Tuna",Weight = 0.1,  Worth = 2820, MaxLength = 245,Mdl = "bluefin_tuna" },
}
